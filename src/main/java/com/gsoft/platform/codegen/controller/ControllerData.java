...
public class ControllerData extends AbstractJavaDataModel{
  ...
  public ControllerData(DaoData daoCode,String moduleName, ServiceData serviceData, Model model) {
	this.daoCode = daoCode;
  ...
  public Map<String, Object> getData() {
    ...
    root.put("modelPath", modelCode.getPackageName());
